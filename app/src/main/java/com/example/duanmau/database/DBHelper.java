...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO thanhvien VALUES (1,'Hà Văn Đạo','2004'),(2,'Nguyễn Văn Cường','2001')");
        db.execSQL("INSERT INTO phieumuon VALUES (1,1,1,'admin','12/04/2023',1,20000),(2,2,2,'admin1','15/04/2023',0,25000)");
        String inseachAdmin = "INSERT INTO thuthu VALUES ('admin','hadao','hadao'),('admin1','hadao1','hadao1')";
